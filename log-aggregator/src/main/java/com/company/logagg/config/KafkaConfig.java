...
/**
 * Kafka config for log-aggregator.
 * Consumes LogCorrelationRequestEvent, produces LogCorrelationResultEvent.
 */
@Configuration
public class KafkaConfig {
    ...
    @Value("${spring.kafka.consumer.group-id:log-aggregator}")
